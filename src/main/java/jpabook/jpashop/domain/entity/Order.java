...
public class Order {
    ...
    // SpringPhysicalNamingStrategy 로 인해 order_date (스네이크 케이스)로 바뀜
    ...
    // 연관관계 편의 메서드 (양방향)
    // set 혹은 get 할때 해당 필드의 연관관계에 속하는 객체도 동시에 초기화
    // 연관관계의 주인 격인 도메인에서 작업
    ...
    // 주문 생성 메서드 (도메인 모델 패턴)
    // 이런 방식이 좋은 이유 : 굳이 여러 메서드를 파헤치지 않아도 주문 생성 관련한 곳은 여기에서 확인하면 됨
